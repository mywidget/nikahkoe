...
// =========== development mode ============
// //LINK DOMAIN WITH URL
define('SITE_UTAMA', 'http://home.local'); 
define('SITE_UNDANGAN', 'http://undangan.local');
define('SITE_ADMIN', 'http://admin.local');

//DOMAIN ONLY
define('DOMAIN_UTAMA', 'home.local');
define('DOMAIN_UTAMA_WWW', 'home.local');
define('DOMAIN_UNDANGAN', 'undangan.local');
define('DOMAIN_ADMIN', 'admin.local');
